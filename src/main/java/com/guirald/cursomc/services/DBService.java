...
import com.guirald.cursomc.domain.ItemPedido;
import com.guirald.cursomc.domain.Pagamento;
import com.guirald.cursomc.domain.PagamentoComBoleto;
import com.guirald.cursomc.domain.PagamentoComCartao;
import com.guirald.cursomc.domain.Pedido;
import com.guirald.cursomc.domain.Produto;
import com.guirald.cursomc.domain.enums.EstadoPagamento;
import com.guirald.cursomc.domain.enums.Perfil;
import com.guirald.cursomc.domain.enums.TipoCliente;
import com.guirald.cursomc.repositories.CategoriaRepository;
import com.guirald.cursomc.repositories.CidadeRepository;
import com.guirald.cursomc.repositories.ClienteRepository;
import com.guirald.cursomc.repositories.EnderecoRepository;
import com.guirald.cursomc.repositories.EstadoRepository;
import com.guirald.cursomc.repositories.ItemPedidoRepository;
import com.guirald.cursomc.repositories.PagamentoRepository;
import com.guirald.cursomc.repositories.PedidoRepository;
import com.guirald.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli2 = new Cliente(null, "Ana Costa", "ana@gmail.com", "91038120144", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("27363392", "93124393"));
		...
		Endereco e3 = new Endereco(null, "Avenida Brasil", "1005", "Sala 5", "Cidade Nova", "38773212", cli2, cid2);
